...
RCT_CUSTOM_VIEW_PROPERTY(refreshAnnotations, BOOL, RCTMap)
{
...
- (void)mapViewDidFinishRenderingMap:(MKMapView *)mapView fullyRendered:(BOOL)fullyRendered {
  [self.bridge.eventDispatcher sendAppEventWithName:@"MapCompleted"
                                               body:@{@"mapcompleted":@"true"}];
}
...
- (MKAnnotationView *)mapView:(__unused MKMapView *)mapView viewForAnnotation:(RCTPointAnnotation *)annotation
{
  ...
  MKPinAnnotationColor pincolor = MKPinAnnotationColorRed;
  if ([annotation.pinColor isEqual: @"green"]) {
    pincolor = MKPinAnnotationColorGreen;
  }
  if ([annotation.pinColor isEqual: @"purple"]) {
